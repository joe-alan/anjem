          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text(dateFormat.format(ride.createdAt),
              ...
              Row(
                children: [
                  Icon(Icons.trip_origin, size: 16, color: config.primaryColor),
                  const SizedBox(width: 8),
                  Expanded(
    ...
    return AlertDialog(
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            _DetailRow(label: l10n.dateLabel, value: dateFormat.format(ride.createdAt)),
            _DetailRow(label: l10n.fromLabel, value: ride.pickupLocation.name),
            _DetailRow(label: l10n.toLabel, value: ride.destinationLocation.name),
            _DetailRow(
                label: l10n.fareLabel,
                value: l10n.currencyFormat(ride.fare.toStringAsFixed(0))),
            if (ride.rider != null)
              _DetailRow(label: l10n.riderFallback, value: ride.rider!.name),
            _DetailRow(
            ...
            if (ride.riderRating != null)
              _DetailRow(
                ...
                value: '${'★' * ride.riderRating!}${'☆' * (5 - ride.riderRating!)}',
              ),
          ],
        ),
      ),
